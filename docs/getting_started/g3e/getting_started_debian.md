...
- For quick fix, find a valid URL for `debian-13.1.0-arm64-DVD-1.iso` from the [Debian CD/DVD archive](https://cdimage.debian.org/mirror/cdimage/archive/) or other trusted sources, then [update the value of ISO_URLS accordingly](#4251-iso_urls).
